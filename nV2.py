...
while(True):
    try:
        ...
        if(flag == 0):
            browser.find_element_by_css_selector("#subj_id > option:nth-child(46)").click()
        ...
        if(flag == 2) :
            ...
            browser.find_element_by_css_selector("#courseBtnDiv > input:nth-child(2)").click()
            # print("PRANOY 2")
            browser.find_element_by_css_selector(".datadisplaytable > tbody:nth-child(1) > tr:nth-child(54) > td:nth-child(4) > form:nth-child(1) > input:nth-child(30)").click()
            # print("PRANOY 3")
            sleep(10)
        ...
        if(flag == 3) :
            browser.find_element_by_css_selector("#subj_id > option:nth-child(52)").click()

            browser.find_element_by_css_selector("#courseBtnDiv > input:nth-child(2)").click()
            # print("PRANOY 2")
            browser.find_element_by_css_selector(".datadisplaytable > tbody:nth-child(1) > tr:nth-child(64) > td:nth-child(4) > form:nth-child(1) > input:nth-child(30)").click()
            # print("PRANOY 3")
            sleep(10)
            value = browser.find_element_by_css_selector(".datadisplaytable > tbody:nth-child(2) > tr:nth-child(3) > td:nth-child(13)")
